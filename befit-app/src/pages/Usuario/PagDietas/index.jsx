...
import ListaExercicios from '../PagExercicios/Components/listaExercicios'
import axios from "axios";
import { useState, useEffect, react } from "react"
import listaStyle from '../PagExercicios/exerciciosStyle.css'
...
function PagExercicios(props) {
    ...
    function listar() {
        let exercicios = axios.get('http://localhost:8080/treinp/' + sessionStorage.getItem("idTreino", props.id))
